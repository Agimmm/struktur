            ...
            <div class="modal fade" id="modal-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                  $no=0;
                  $result = mysqli_query($config, "SELECT * FROM struktur_umum ORDER BY id ASC ");
                  while($data = mysqli_fetch_array($result)){
                    ...
                    <tr>
                      ...
                      <td><?= $data['nama'] ?></td>
                      <td><?= $data['jabatan'] ?></td>
                      <td><a href="insert.php?delete1&id=<?= $data['id'] ?>" class="btn btn-warning">Hapus</a><a href="struktur_umum.php" class="btn btn-primary" data-toggle="modal" data-target="#edit<?= $data['id'] ?>">edit</a></td>
                    </tr>
